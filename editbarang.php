...
$query = "SELECT * FROM tb_barang WHERE kd_brg='$kode'";
...
//update barang
$query = "UPDATE tb_barang SET nm_brg='$nama',satuan='$satuan', harga='$harga', harga_beli='$hargabeli',stok='$stok',stok_min='$stok_min' WHERE kd_brg='$kode'";
$sql = mysqli_query ($conn,$query);
if ($sql) {
